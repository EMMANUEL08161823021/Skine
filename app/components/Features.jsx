...
const Features = () => {
  ...
  return (
    <section
      id="skin-finder"
      className="w-full bg-[#FCEFF1] px-5 py-20 md:px-10 lg:px-14"
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="overflow-hidden rounded-[38px] bg-white px-6 py-14 shadow-[0_25px_70px_rgba(80,30,40,0.08)] md:px-12 lg:px-20 lg:py-20">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mx-auto inline-flex items-center gap-2 rounded-full bg-[#F8DDE3] px-5 py-2">
              <Sparkles
                size={15}
                className="text-[#B5284D]"
              />

              <span className="font-sans text-xs font-bold uppercase tracking-wide text-[#B5284D]">
                Expert-Informed Skin Finder
              </span>
            </div>

            <h2 className="mt-7 font-heading text-4xl font-bold leading-[0.95] tracking-[-0.04em] text-[#B5284D] md:text-6xl lg:text-7xl">
              FIND THE RIGHT
              <br />
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                {skinConcerns.map((item) => (
                  <button
                    ...
                    className="group rounded-3xl border border-[#F1D4DB] bg-white p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:border-[#B5284D] hover:shadow-lg"
                  >
                    ...
                    <div className="mt-5 flex items-center gap-2 font-sans text-xs font-bold text-[#B5284D]">
                      SELECT
                      <ArrowRight
                        size={14}
              ...
              <div className="mx-auto mt-8 grid max-w-4xl gap-4 sm:grid-cols-2">
                ...
                {skinTypes.map((item) => (
                  <button
                    ...
                    className="group rounded-3xl border border-[#F1D4DB] p-6 text-left transition-all duration-300 hover:-translate-y-1 hover:border-[#B5284D] hover:shadow-lg"
                  >
            ...
            <div className="mx-auto mt-12 max-w-4xl text-center">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                ...
                {result.products.map((product) => (
                  <div
                    key={product}
                    className="rounded-2xl bg-[#FFF7F8] p-5 text-left"
                  >
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                <Link
                  href="#products"
                  className="rounded-full bg-[#B5284D] px-7 py-4 font-sans text-sm font-bold text-white transition hover:bg-[#93203F]"
                >
                ...
                <button
                  onClick={resetFinder}
                  className="flex items-center gap-2 rounded-full border border-[#B5284D]/20 px-7 py-4 font-sans text-sm font-bold text-[#B5284D] transition hover:bg-[#FFF1F4]"
                >
                  <RotateCcw size={15} />
                  START AGAIN
                </button>
